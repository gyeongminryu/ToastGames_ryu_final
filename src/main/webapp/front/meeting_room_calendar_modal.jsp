                            ...
                            <li>
                                <div class="tst_flex">
                                    <div class="tst_col6">
                                        ...
                                        <input type="datetime-local" name="meet_start_date" />
                                    </div>
                                    <div class="tst_col6">
                                        <label class="form_label">회의 종료 시각</label>
                                        <input type="datetime-local" name="meet_end_date" />
                                    </div>
                                </div>
                            </li>
                            <li>
                                ...
                                <div>
                                    <select id="meeting_room_id" name="room_idx" onchange="<!-- 회의실을 선택하면 회의실 정보를 수정하는 함수명을 입력하세요 -->">
