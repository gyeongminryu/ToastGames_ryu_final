    ...
    <div class="tst_modal_container">
        <form>
            ...
            <div class="tst_modal_body">
                <ul class="tst_list list_no_desc list_block">
                    <li>
                        ...
                        <input type="password" id="currentPassword" maxlength="100" placeholder="기존 비밀번호를 입력하세요" />
                        <!-- 비밀번호가 틀렸을 때 클래스 'disp_hide'를 제거하세요 -->
                        <p class="min font_caution disp_hide" id="currentPasswordError">비밀번호를 확인하세요.</p>
                        <!-- 비밀번호가 맞았을 때 클래스 'disp_hide'를 제거하세요 -->
                        <p class="min disp_hide" id="newPasswordPrompt">기존 비밀번호를 확인했습니다. 새 비밀번호를 입력하세요.</p>
                    </li>
                    <li>
                        <hr class="separator" />
                    </li>
                    <li>
                        ...
                        <input type="password" id="newPassword" maxlength="100" placeholder="새 비밀번호를 입력하세요" />
                        <hr class="separator separator_min" />
                        <input type="password" id="confirmPassword" maxlength="100" placeholder="새 비밀번호를 입력하세요" />
                        <!-- 비밀번호와 확인값이 틀릴 때 클래스 'disp_hide'를 제거하세요 -->
                        <p class="min font_caution disp_hide" id="passwordMismatchError">비밀번호와 비밀번호 확인값은 동일해야 합니다.</p>
                    </li>
                    <li>
                        <hr class="separator" />
                    </li>
            ...
            <div class="tst_modal_footer">
                <div class="tst_flex">
                    <div class="tst_col6">
                        <button type="button" onclick="submitPasswordChange()" class="btn_primary btn_full">비밀번호 변경하기</button>
                    </div>
                    <div class="tst_col6">
