                        ...
                        <form>
                            <div class="tst_search_container width_full">
                                <div class="tst_search_input">
                                    <input type="text" name="keyword_category" maxlength="50" class="input_min input_underline" placeholder="부서목록" readonly />
                                </div>
                        ...
                        <table class="tst_table table_align_left">
                            ...
                            <tr>
                                ...
                                <th class="td_no_padding">
                                    <span onclick="location.href='./manage_employee_resign_list.go'">전체 보기</span>
                                </th>
                            </tr>
                            <!-- //전 직원 조회 (필터링 초기화) -->
...
function fetchDeptMembers(deptIdx) {
    $.ajax({
        url: './get_resign_dept_members.ajax', // 요청 경로 부서이면서 스테이트먼트가 3인 경우
        type: 'GET',
...
function renderDeptMembers(members) {
    ...
    $.each(members, function(index, member) {
        ...
        membersTable.append(
            ...
            '<td>' + formatDate(member.empl_resig_date) + '</td>' +
            '</tr>'
        );
    });
}
