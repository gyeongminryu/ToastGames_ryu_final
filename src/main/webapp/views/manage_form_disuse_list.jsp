        ...
        <div class="tst_contents">
            <div class="tst_contents_inner">
                ...
                <ul class="tst_title list_no_desc list_inline">
                    ...
                    <li class="tst_title_item tst_title_item_active" onclick="location.href='/manage_form_disuse_list.go'">
                ...
                <div class="tst_flex">
                    ...
                    <div class="tst_col4">
                        <table class="tst_table table_no_padding">
                            ...
                            <!-- 문서 양식을 선택했을 경우 -->
                            <tr class="select_form_data disp_hide td_no_underline">
                                <td>
                            ...
                            <tfoot>
                            <tr>
                                <td class="select_form_button"></td>
                            </tr>
                            </tfoot>
                        </table>
                    </div>
