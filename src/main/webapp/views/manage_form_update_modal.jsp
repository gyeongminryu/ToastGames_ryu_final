...
<div class="tst_modal tst_modal_alert tst_modal_register">
    <div class="tst_modal_container">
        ...
        <div class="tst_modal_footer">
            <div class="tst_flex">
                <div class="tst_col6">
                    <button onclick="registWIP()" class="btn_primary btn_full">양식 등록하기</button>
                </div>
                <div class="tst_col6">
...
<div class="tst_modal tst_modal_alert tst_modal_delete">
    <div class="tst_modal_container">
        ...
        <div class="tst_modal_footer">
            <div class="tst_flex">
                <div class="tst_col6">
                    <button onclick="deleteWIP()" class="btn_primary btn_full">삭제하기</button>
                </div>
                <div class="tst_col6">
...
<div class="tst_modal tst_modal_alert tst_modal_disuse">
    <div class="tst_modal_container">
        <div class="tst_modal_header">
            <h1 class="tst_modal_title">양식 삭제하기</h1>
