                    ...
                    <div class="tst_col9">
                        ...
                        <table class="tst_table table_align_left">
                            ...
                            <tr>
                                ...
                                <td colspan="3">${employee.bank_name} ${employee.empl_account} (예금주: ${employee.empl_name})</td>
                            </tr>
                            <tr>
...
document.getElementById('convertedTime').innerHTML =
    ...
    '<button onclick="location.href=\'/member_work_record.go?emplidx=${employee.empl_idx}\'" class="btn_min btn_primary">상세보기</button>';
if(weekWork>52){
