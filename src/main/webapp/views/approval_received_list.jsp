        ...
        <div class="tst_contents">
            <div class="tst_contents_inner">
                ...
                <ul class="tst_tablist list_no_desc list_inline">
                    <li class="tst_tablist_item all tst_tablist_item_active" onclick="approval_pageCall(1,'전체','탭')">
                        <h3>전체 보기</h3>
                    </li>
                    <li class="tst_tablist_item unread" onclick="approval_pageCall(1,'읽지 않음','탭')">
                        <h3>읽지 않음</h3>
                    </li>
                    <li class="tst_tablist_item continue" onclick="approval_pageCall(1,'결재중','탭')">
                        <h3>결재중</h3>
                    </li>
                    <li class="tst_tablist_item approved" onclick="approval_pageCall(1,'승인','탭')">
                        <h3>결재 승인</h3>
                    </li>
