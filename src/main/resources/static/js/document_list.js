...
function printList(list, totalIdx, currentPage) {
    ...
    if (list.length > 0) {
        for (let i = 0; i < list.length; i++) {
            ...
            tags += '<td>' + list[i].form_subject + '</td>'
            tags += '<td class="td_align_left">';

            if (list[i].authority) {
                tags += '<span class="tst_badge_min btn_secondary margin_right">열람 가능</span>';
                tags += '<span onclick="location.href=\'/document_detail.go?doc_idx=' + list[i].doc_idx + '\'" class="tst_pointer">';
            } else {
            ...
            tags += '<td>' + list[i].doc_write_date.substring(0, 10) + '</td>';

            if (list[i].dept_idx_3 > 0) {
                //console.log("final approval is the third");
                //console.log(list[i].dept_idx_3);
            ...
            } else if (list[i].dept_idx_2) {
                //console.log("final approval is the second");
                ...
                //console.log("final approval is the first");
            ...
            tags += '<td>' + list[i].doc_end_date.substring(0, 10) + '</td>';
            tags += '</tr>';
        }
    } else {
