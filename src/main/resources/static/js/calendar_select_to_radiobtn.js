...
//직원선택
function select_schedule_empl(itemData) {
    // JSON 문자열을 객체로 변환
...
function updateScheduleEmplTable() {
    // tbody 선택
    ...
    for (var i = 0; i < selectedEmplList.length; i++) {
        ...
        actionCell.innerHTML =
            '<i class="bi bi-dash-circle-dotted" onclick="removeScheduleEmpl(' +
            i +
            ')"></i>';
...
function removeScheduleEmpl(index) {
