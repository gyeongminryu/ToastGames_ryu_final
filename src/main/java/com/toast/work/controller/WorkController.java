...
public class WorkController {
    ...
    // 사원 근태 상세보러 가기
    // work_record 페이지 이동
    @GetMapping(value = "/member_work_record.go")
    public String workMemberRecord(@RequestParam String emplidx,@RequestParam(value = "startDate", required = false) String startDate,HttpSession session, Model model) {
       
    	int empl_idx = Integer.parseInt(emplidx);
    	//int empl_idx = (int) session.getAttribute("empl_idx");
